...
function Auth() {
  ...
  useEffect(() => {
   if(processStatus) setPopup(<SuccessPopup title="Account Created Successfully" message={popupMessage} path="/" butonName="Okay"/>);
  }, [processStatus]);
    ...
    <>
      ...
      <div className="flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8 bg-primary">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img className="mx-auto h-7 w-40" src={logo} alt="Your Company" />
